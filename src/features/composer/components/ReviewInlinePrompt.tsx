...
const PresetStep = memo(function PresetStep({
  ...
  return (
    <div className="review-inline-section">
      ...
      >
        <span className="review-inline-option-title">{t("reviewInline.baseBranchTitle")}</span>
      ...
      <button
        ...
        disabled={isSubmitting}
      >
        <span className="review-inline-option-title">{t("reviewInline.uncommittedTitle")}</span>
      </button>
      <button
        type="button"
        ...
        disabled={isSubmitting}
      >
        <span className="review-inline-option-title">{t("reviewInline.commitTitle")}</span>
      </button>
      <button
        type="button"
        ...
        disabled={isSubmitting}
      >
        <span className="review-inline-option-title">{t("reviewInline.customTitle")}</span>
      </button>
    </div>
  );
});
    ...
    <div className="review-inline-section">
      ...
      <div className="review-inline-list" role="listbox" aria-label={t("reviewInline.baseBranches")}>
        {reviewPrompt.isLoadingBranches ? (
          ...
          <div className="review-inline-empty">{t("reviewInline.noBranchesFound")}</div>
        ) : (
...
const CommitStep = memo(function CommitStep({
  ...
  return (
    <div className="review-inline-section">
      ...
      <div className="review-inline-hint">{t("reviewInline.selectRecentCommit")}</div>
      <div className="review-inline-list" role="listbox" aria-label={t("reviewInline.commits")}>
        {reviewPrompt.isLoadingCommits ? (
          <div className="review-inline-empty">{t("gitPanel.loadingCommits")}</div>
        ) : commits.length === 0 ? (
          <div className="review-inline-empty">{t("reviewInline.noCommitsFound")}</div>
        ) : (
...
export const ReviewInlinePrompt = memo(function ReviewInlinePrompt({
  ...
  const title = useMemo(() => {
      switch (step) {
        ...
        case "custom":
          return t("reviewInline.customInstructionsTitle");
        case "preset":
        default:
