  ...
  return (
    <div className="sidebar-corner-actions">
      {showAccountSwitcher && (
        <div className="sidebar-account-menu" ref={accountMenuRef}>
          <MenuTrigger
            ...
            title={t("uiText.sidebar.account")}
            data-tooltip={t("uiText.sidebar.account")}
      ...
      <button
        ...
        title={t("uiText.sidebar.settings")}
        data-tooltip={t("uiText.sidebar.settings")}
        data-tooltip-align="start"
      >
      ...
      {showDebugButton && (
        <button
          ...
          title={t("uiText.sidebar.debugLog")}
          data-tooltip={t("uiText.sidebar.debugLog")}
          data-tooltip-align="start"
        >
