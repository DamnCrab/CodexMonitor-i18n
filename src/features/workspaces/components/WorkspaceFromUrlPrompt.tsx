...
export function WorkspaceFromUrlPrompt({
  ...
  return (
    <ModalShell
      ariaLabel={t("workspaceFromUrlPrompt.ariaLabel")}
    ...
    >
      <div className="workspace-from-url-modal-content">
        <div className="ds-modal-title">{t("workspaceFromUrlPrompt.title")}</div>
        <label className="ds-modal-label" htmlFor="workspace-url-input">
          {t("workspaceFromUrlPrompt.remoteGitUrl")}
        </label>
        <input
          ...
          placeholder={t("workspaceFromUrlPrompt.urlPlaceholder")}
        />
        <label className="ds-modal-label" htmlFor="workspace-url-target-name">
          {t("workspaceFromUrlPrompt.targetFolderName")}
        </label>
        <input
          ...
          placeholder={t("workspaceFromUrlPrompt.targetFolderPlaceholder")}
        />
        <label className="ds-modal-label" htmlFor="workspace-url-destination">
          {t("workspaceFromUrlPrompt.destinationParentFolder")}
        </label>
        ...
        <div className="ds-modal-actions">
          ...
          >
            {isBusy
              ? t("workspaceFromUrlPrompt.cloning")
              : t("workspaceFromUrlPrompt.cloneAndAdd")}
          </button>
        </div>
      </div>
    </ModalShell>
